...
- (void)viewControler:(UIViewController *)viewController AddSubLabelText:(NSString *)labelText {
    ...
    [label mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(viewController.view.mas_centerX);
        make.centerY.mas_equalTo(viewController.view.mas_centerY);
        make.center.mas_equalTo(viewController.view.center);
