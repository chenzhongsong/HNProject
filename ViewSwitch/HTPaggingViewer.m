...
- (HTPaggingNavbar *)paggingNavbar {
        if (_paggingNavbar == nil) {
            _paggingNavbar = [[HTPaggingNavbar alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width -(self.viewControllers.count ==2?120:30), 31) withNumber:self.viewControllers.count withTitles:[self.viewControllers valueForKey:@"title"]];
